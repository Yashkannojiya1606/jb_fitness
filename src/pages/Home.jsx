...
export default function Home() {
  ...
  return (
    <div className="w-full overflow-hidden">
              ...
              >
                {activeIndex === idx ? (
                  ...
                  >
                    ...
                    <p className="mt-2 text-[18px] text-white/80 leading-relaxed">
                      {program.description}
                      <br />
                      This program helps you transform physically and mentally
                      with expert guidance and proven methods.
                    </p>
                    <button className="mt-6 w-full bg-white text-black px-4 py-2 rounded hover:bg-gray-200 transition font-medium text-sm">
                      Explore More
                    </button>
      ...
      {/* ✅ ADDITIONAL SECTIONS ONLY ON HOME */}
